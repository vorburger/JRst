...
<!-- TODO: This is based on Docutils 0.3.7 - an update to 0.4 is needed -->
...
<xsl:stylesheet
  ...
  -->
  <!-- TODO: Is this correct treatment? No special markup? -->
  ...
  <xsl:template
    ...
    <xsl:if
	test="@class">
      <!-- TODO: @classes must be used here and everywhere -->
      <xsl:if
