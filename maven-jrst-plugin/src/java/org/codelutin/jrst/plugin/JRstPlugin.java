...
public class JRstPlugin extends AbstractMojo implements FileAction {    
    ...
    /**
     * ArrÍte la gÈnÈration en cas d'erreurs
     * 
    ...
    private void actionGenerate(){
        getLog().info("GÈnÈration des fichier xdocs ‡† partir des fichiers rst");
    ...
    private void actionCopy(){          
        ...
        /* Execution de la t√¢che ant copy */
         
        /* Cr√©ation d'un projet ant */
